...
## Project Structure
    ...
    ├── testapiautosetting_127300  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127300`
...
2. Clone this repo and `cd testapiautosetting_127300`
